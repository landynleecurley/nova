// Lightweight inline SVG icons (lucide-style, stroke = currentColor).
const base = {
  viewBox: "0 0 24 24",
  fill: "none",
  stroke: "currentColor",
...
function Svg({ className = "w-5 h-5", children, ...rest }) {
  return (
...
export function IconPlay({ className = "w-5 h-5", ...rest }) {
  return (
...
export function IconPause({ className = "w-5 h-5", ...rest }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" {...rest}>
...
export function IconVolumeMute(p) {
  return (
    <Svg {...p}>
      <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" />
...
export function IconMaximize(p) {
  return (
    <Svg {...p}>
