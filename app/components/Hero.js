...
export default function Hero({ item }) {
  ...
  return (
    <section className="relative h-[70vh] min-h-[460px] w-full">
      ...
      <div className="relative z-10 h-full flex flex-col justify-end items-center text-center md:items-start md:text-left px-6 md:px-12 pb-16 max-w-3xl mx-auto md:mx-0">
        ...
        <div className="flex items-center justify-center md:justify-start gap-3 text-sm text-white/80 mb-4">
